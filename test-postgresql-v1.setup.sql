...
DROP TABLE IF EXISTS t_uuid_64;
DROP TABLE IF EXISTS t_uuid_32;
...
-- FROM: https://github.com/ancoron/pg-uuid-int64
CREATE EXTENSION IF NOT EXISTS uuid_int64;

-- FROM: https://github.com/ancoron/pg-uuid-int32
CREATE EXTENSION IF NOT EXISTS uuid_int32;
...
CREATE INDEX t_uuid_idx_timestamps ON t_uuid (uuid_v1_timestamp(id)) TABLESPACE faster;

CREATE TABLE t_uuid_v1 (id uuid_v1 PRIMARY KEY USING INDEX TABLESPACE faster) TABLESPACE fast;

CREATE TABLE t_uuid_64 (id uuid_int64 PRIMARY KEY USING INDEX TABLESPACE faster) TABLESPACE fast;

CREATE TABLE t_uuid_32 (id uuid_int32 PRIMARY KEY USING INDEX TABLESPACE faster) TABLESPACE fast;
